    ...
    <a-card :body-style="{padding: '24px 32px'}" :bordered="false">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="{lg: {span: 10}, sm: {span: 17} }"
        >
          <a-radio-group name="radioGroup" :defaultValue="1" v-model="caseReport.etiologicEx" disabled>
        ...
        <a-form-item
          ...
          :wrapperCol="{lg: {span: 10}, sm: {span: 17} }"
        >
          <a-input placeholder="标本名称" style="width: 200px" v-model="caseReport.etiologicSpecName" readonly="true" />
        </a-form-item>
        <a-form-item
          v-bind="formItemLayout"
          label="易感因素"
        ...
        >
          <div>
            ...
            <a-checkbox-group :options="plainOptions" v-model="caseReport.preFactor" @change="onChange" disabled/>
